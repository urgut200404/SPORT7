        ...
        <div class="card">
            ...
            <div class="comments">
                ...
                <div class="comment-container">
                    ...
                    <p class="comment-content">
                        Я пользуюсь этой платформой уже некоторое время и я действительно впечатлен! Интерфейс интуитивно понятен и прост в использовании, а функции — это как раз то, что мне было нужно для оптимизации моего рабочего процесса.
                    </p>
                </div>
            </div>
             <!-- ....... -->
             ...
             <div class="comments">
                ...
                <div class="comment-container">
                    <div class="user">
                        ...
                        <div class="user-info">
                            <span>Mavlonberdiyev Xudoyberdi</span>
                            <p>Wednesday, March 13th at 2:45pm</p>
                        </div>
                    </div>
                    <p class="comment-content">
                        Men ushbu Platformadan bir muncha vaqt foydalanaman va men juda hayratdaman! Interfeys intuitiv va ulardan foydalanish oson va funksiyalar mening ish jarayonimni soddalashtirish uchun kerak bo'lgan narsadir., Men yaqin do'slarimga ham tafsiya qilganman
                    </p>
                </div>
            </div>
            <!-- ..... -->
            ...
            <div class="comments">
                ...
                <div class="comment-container">
                    ...
                    <p class="comment-content">
                        I've been using this Platform for a while now and I'm really impressed! The interface is intuitive and easy to use, and the features are just what I needed to streamline my workflow.
                    </p>
                </div>
            </div>
            <!-- ... -->
                    ...
                    <div>
                        <div class="formatting">
                            ...
                            <button type="button">
                                <svg fill="none" viewBox="0 0 24 24" height="16" width="16"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-width="2.5" stroke="#707277" d="M12 4H19">
                                    </path>
                                    <path stroke-linecap="round" stroke-width="2.5" stroke="#707277" d="M8 20L16 4">
                                    </path>
                                    <path stroke-linecap="round" stroke-width="2.5" stroke="#707277" d="M5 20H12">
                                    </path>
                                </svg>
                            </button>
                            <button type="button">
                                <svg fill="none" viewBox="0 0 24 24" height="16" width="16"
                                    ...
                                    <path stroke-linecap="round" stroke-width="2.5" stroke="#707277" d="M3 21H21">
                                    </path>
                                </svg>
                            </button>
                            <button type="button">
                            ...
                            <button type="button">
                                <svg fill="none" viewBox="0 0 24 24" height="16" width="16"
                                    ...
                                    <path stroke-linejoin="round" stroke-linecap="round" stroke-width="3"
                                        stroke="#707277" d="M8.00897 9L8 9M16 9L15.991 9"></path>
                                </svg>
                            </button>
