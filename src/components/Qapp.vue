<template>
    <div class="d-flex justify-content-center">
        <!-- <div class="row" > 
           <div class="col-6">
                <img src="../assets/404.png" alt="" class="w-100 h-100">
           </div>
           <div class="col-6 qapp pe-0">
                <div >
                    <img src="../assets/ggplay.jpg" class="w-75 border" alt="">
                </div>
                <div>
                    <img src="../assets/apstore.png" class="w-75 border" alt="">
                </div>
           </div>
        </div> -->
        <div class="card ">
            <span class="small-text">Hozir Yuklang!</span>
            <span class="title">Mobil ilovamizni yuklab oling.</span>
            <span class="desc">IOS uchun Lorem mobil banking ilovasini yuklab oling&amp; Onlayn boshqarish uchun Android
                pul.</span>
            <div class="buttons">
                <a href="#" class="button">
